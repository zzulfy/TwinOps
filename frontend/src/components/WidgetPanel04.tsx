        ...
        chart.setOption(
          {
            ...
            legend: {
              right: 0,
              top: 4,
              textStyle: { color: "#e4ecf5", fontSize: 11 },
              data: legendData,
            },
            ...
            xAxis: {
              ...
              boundaryGap: false,
              data: labels,
              axisLabel: { color: "#e4ecf5", fontSize: 10, formatter: (value: string) => value.slice(-5) },
            },
            yAxis: {
              type: "value",
              name: "故障率",
              min: 0,
              max: 100,
              axisLabel: { color: "#e4ecf5", formatter: "{value}%" },
              nameTextStyle: { color: "#e4ecf5" },
              splitLine: { lineStyle: { color: "rgba(128,164,211,0.25)" } },
            },
            dataZoom: [
              { type: "inside", start: 70, end: 100 },
              { type: "slider", height: 14, bottom: 8, start: 70, end: 100, textStyle: { color: "#e4ecf5" } },
            ],
            series,
          },
          true
