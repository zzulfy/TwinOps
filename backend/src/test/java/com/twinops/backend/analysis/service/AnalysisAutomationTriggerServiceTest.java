...
class AnalysisAutomationTriggerServiceTest {
    ...
    void shouldCreateSingleProcessingReportAndPublishSingleKafkaWorkload() {
        ...
        when(analysisService.createProcessingReport(eq("AGGREGATED"), any(), any()))
            .thenReturn(new AnalysisReportDto(11L, "AGGREGATED", "x", null, null, null, null, null, null, java.util.List.of(), java.util.List.of(), null, null, null, "processing", null, "2026-04-03 12:00:00", null));
    ...
    void shouldMarkReportFailedWhenPublishFails() {
        ...
        when(analysisService.createProcessingReport(eq("AGGREGATED"), any(), any()))
            .thenReturn(new AnalysisReportDto(21L, "AGGREGATED", "x", null, null, null, null, null, null, java.util.List.of(), java.util.List.of(), null, null, null, "processing", null, "2026-04-03 12:00:00", null));
