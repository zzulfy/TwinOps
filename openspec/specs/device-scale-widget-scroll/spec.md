# device-scale-widget-scroll

## Purpose

Define accessibility and overflow behavior for the device scale module so all entries remain visible and reachable within fixed-height dashboard panels.
