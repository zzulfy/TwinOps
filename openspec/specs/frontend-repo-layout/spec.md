...
Define repository-level requirements for colocating frontend assets into a dedicated frontend workspace and standardizing frontend command/script locality.
