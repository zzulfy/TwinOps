# frontend-owned-simulation-device-ui Specification

## Purpose
Define frontend-owned simulation device UI configuration, backend data-only payload expectations, and runtime 1:1 consistency guarantees for the dashboard simulation scene.
